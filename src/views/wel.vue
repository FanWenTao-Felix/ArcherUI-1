<template>
  <basic-container>
    <p style="text-align: center">
      ...
      <img src="https://img.shields.io/badge/Spring%20Blade-2.6.1.RELEASE-blue.svg" alt="Coverage Status"/>
    ...
    <el-row>
      <el-col :span="16">
        <el-collapse v-model="activeNames" @change="handleChange">
          <el-collapse-item title="欢迎使用Archer全能代码生成器" name="1">
            <div>1.Archer是基于BladeX+Saber开发的独立系统</div>
            <div>2.支持自定义模型、模版 、业务建模，支持多种模板引擎，在线配置</div>
            <div>3.若能熟练进行业务建模、模板编写，理论上可以使用Archer进行任何代码的生成</div>
            <div>4.包括但不限定于可以生成java、vue、react、go、c#、php等多种代码文件</div>
            <div>5.使用Archer可以大幅度提升开发效率，不再为重复工作发愁</div>
          </el-collapse-item>
      ...
      <el-col :span="8">
        <el-collapse v-model="logActiveNames" @change="handleChange">
          <el-collapse-item title="1.1.0.RELEASE发布，升级依赖，优化模板，支持代码导出" name="2">
            <div>1.升级 SpringBlade 2.6.1</div>
            <div>2.升级 SpringBoot 2.2.4</div>
            <div>3.升级 Knife4j 2.0.1</div>
            <div>4.支持Knife4j最新版注解</div>
            <div>5.支持代码生成在线导出</div>
            <div>6.优化代码生成模板，适配BladeX最新版本</div>
          </el-collapse-item>
          <el-collapse-item title="1.0.0.RELEASE发布，全能代码生成器第一版发布" name="1">
            <div>1.全能代码生成器第一版发布</div>
            <div>4.支持mysql、oracle、postgresql读取并逆向生成模型</div>
            <div>2.支持在线自定义代码生成模板</div>
            <div>3.支持不同语言的代码生成</div>
            <div>5.支持全方位的插件类型自定义</div>
            <div>6.支持模型、模板灵活组装生成自定义方案</div>
            <div>7.支持单表代码急速生成</div>
            <div>8.支持批量方案代码生成</div>
            <div>9.更多更能敬请期待</div>
          </el-collapse-item>
        </el-collapse>
      </el-col>
